...
export function HeroCarousel({ slides }: HeroCarouselProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-primary" aria-label="Featured catalogs">
      <div ref={emblaRef} className="overflow-hidden">
        <div className="flex">
          {slides.map((slide) => (
            <div key={slide.id} className="relative min-w-0 flex-[0_0_100%]">
              <div className="relative aspect-[16/6.3] min-h-[294px] w-full sm:aspect-[10/3] lg:min-h-[364px]">
                <Image
                  src={slide.imageUrl}
                  alt={slide.imageAlt}
                  fill
